...
var group_test = ax.create_commands_group("Creds-BOF", [cmd_askcreds, cmd_autologon, cmd_credman, cmd_hashdump, cmd_nanodump, cmd_nanodump_ppl_dump, cmd_nanodump_ppl_medic, cmd_nanodump_ssp]);
